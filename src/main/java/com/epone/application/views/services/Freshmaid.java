...
public class Freshmaid extends EponePage {
    private final String heading = "<span style=\"color:green\">Fresh Maids<span>";
    private final String bodyStm1 = "Fresh maids who have not worked abroad might require extra patience" +
    ...
    private final String bodyStm2 = "Since they are in their home country when selected, it can take anywhere from 3 to 8 weeks," +
            " depending on their nationality, to complete local paperwork before they can come to your home.";

    private final String bodyStm3 = "New maids usually earn less than experienced ones. Still, they are not necessarily worse at their job because they have been trained.";
