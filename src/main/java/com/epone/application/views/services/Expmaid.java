...
public class Expmaid extends EponePage {
    private static final String heading = "<span style=\"color:green\">Experienced Maids<span>";
    private static final String bodyStm1 = "Experienced maids typically require significantly less training and supervision"
            +
    ...
    private static final String bodyStm2 = "Since they are in their home country during the selection and application process, the waiting time for the maid to arrive at your home may vary between 3 to 8 weeks, depending on her nationality.";
    private static final String bodyStm3 = "Due to their previous overseas work experience, experienced maids typically request higher salaries compared to new hires, with variations based on the duration of their previous employment and their language proficiency.";
