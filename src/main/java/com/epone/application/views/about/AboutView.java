...
public class AboutView extends VerticalLayout {
        ...
        private static final String whoAreWeHeadingHTML = "<span>Who</span> <span style=\"color:green\">Are We?</span>";
        private static final String whoAreWeStatement1 = "Our company, EP One Manpower Pte Ltd is one of the leading maid agencies in "
                        + //
        ...
        private static final String whoAreWeStatement2 = "With the convenience of 3 branches ( Bukit Timah, Hougang and Sin Ming) "
                        + //
        ...
        private static final String whoAreWeStatement3 = "We pride ourselves in providing good customer services, quality helpers and other "
                        + //
        ...
        private static final String visionStatement = "To source, train and match most suitable fdw to our invaluable clients with professional services.";
        private static final String visionHeadingHTML = "<span>Our</span> <span style=\"color:green\">Vision</span>";

        private static final String historyHeadingHTML = "<span>Our</span> <span style=\"color:green\">History</span>";
        private static final String history1 = "EP One Manpower Pte Ltd was established in 2012, after the owner of the agency has several issues with his own Foreign Domestic Worker (FDW) and several business trips (food businesses) to countries such as Indonesia, Philippines and Myanmar. Being a person good in processes improvement and character enhancement, he started off the Employment Agency's business by recruiting personally a few Indonesian candidates with good potential. He trained them personally, brief them and inculcate in them value of hard working, ability to take hardship, meticulous in doing chores and hygiene.";
        private static final String history2 = "Today EP One Manpower Pte Ltd has 3 branches located in Bukit Timah, Hougang and Sin Ming areas, with several Training Centres overseas in Myanmar, Philippine, Indonesia and India. EP One Manpower Pte Ltd is committed to match you with the most competence workers through constant screening in the worker's home-country, training and inculcating the correct value in the workers, prior to come into Singapore, and with best services.";

        private static final String myanmarHeading = "<span>Face to Face</span> <span style=\"color:green\">Interview</span><span> in Myanmar</span>";
        ...
        public AboutView() {
                ...
                explainVertical
                                .add(getCardFormat(getHeading(historyHeadingHTML), new Paragraph(history1),
